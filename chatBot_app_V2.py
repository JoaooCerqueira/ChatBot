...
if "assistant" not in st.session_state:
    st.session_state.assistant = st.session_state.client.beta.assistants.retrieve(assistant_id=assistant_id)
...
if "file_id_list" not in st.session_state:
    ...
    for file in st.session_state.assistant.tool_resources.code_interpreter.file_ids:
        st.session_state.file_id_list.append(file)
